        ...
        <form onSubmit={submitHandler}>
            <div className='new-expense__controls'>
                ...
                <div className="new-expense__control">
                    ...
                    <input id='amount' value={enteredAmount} type="number" min="0.01" step="0.01" onChange={amountChangeHandler}/>
                </div>
                <div className="new-expense__control">
                    <label htmlFor="date">Date</label>
                    <input id='date' value={enteredDate} type="date" min="2021-01-01" max="2022-12-31" onChange={dateChangeHandler}/>
                </div>
            </div>
